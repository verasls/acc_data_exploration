...
Code to tidy the date is shown below.
...
*Post  hoc* tests showed that pRGRF values predicted with correct accelerometer placement did not differ from each other neither from pRGRF measured by force plates (*p*>0.05). All pRGRF values predicted with incorrect accelerometer placement significantly differed from each other and from measured pRGRF (*p*<0.001).
